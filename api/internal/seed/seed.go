...
func ensureZdorovayaSpina(ctx context.Context, repo *db.Repo) (uuid.UUID, error) {
	...
	lessons := []db.LessonInput{
		...
		{Title: "Осанка", Slug: "osanka",
			ContentMD:   "«Болит спина или не болит спина – это только показатель: есть у человека физическая культура в жизни или нет». Алексей говорит, что осанка – это не про лопатки назад, а про лёгкое усилие на раскрытие грудной клетки и про то, как мы чувствуем себя в моменте.",
		...
		{Title: "Бонус-аудио: практика расслабления", Slug: "praktika-rasslableniya",
			ContentMD:   "30-минутная йога-нидра. Простая практика на внимание к разным частям тела. Алексей: «Возможно, вы уснёте, такое частенько случается – нормально». Слушайте в кровати, в дороге, в обед.",
